...
#and downloading the data. If you don't have Tweepy installed in your machine, 
#go to this link, and follow the installation instructions.

#Next create, a file called twitter_streaming.py, and copy into it the code below. 
#Make sure to enter your credentials into access_token, access_token_secret, consumer_key, 
#and consumer_secret.
